...
$preamp['config']['custom_post_type']['wp-photo-gallery'] = array(
	...
	'labels' => array(
		...
		'menu_name'          => _x( 'WP Gallery', 'admin menu', 'wp-photo-gallery' ),
		'name_admin_bar'     => 'WP Gallery',
		'add_new'            => _x( 'Add New Gallery', 'gallery', 'wp-photo-gallery' ),
		...
		'search_items'       => __( 'Search Gallery', 'wp-photo-gallery' ),
		'not_found'          => __( 'No Gallery found.', 'wp-photo-gallery' ),
		'not_found_in_trash' => __( 'No Gallery found in Trash.', 'wp-photo-gallery' ),
